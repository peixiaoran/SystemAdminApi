...
namespace SystemAdmin.Model.FormBusiness.Forms.DocumentCirculate.Dto
{
    /// <summary>
    /// 传签单基础信息Dto
    /// </summary>
    public class DocumentCirculateDto
    {
        /// <summary>
        /// 传签单Id
        /// </summary>
        ...
        /// 发文单位
        /// </summary>
        public string? IssueDept { get; set; } = string.Empty;

        /// <summary>
        /// 传签目的
        /// </summary>
        public string? CirculationPurpose { get; set; } = string.Empty;
